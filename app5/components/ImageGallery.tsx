        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className="p-4 flex-1 flex flex-col bg-white">
              <p className="text-[11px] text-slate-600 line-clamp-2 font-medium flex-1 italic leading-relaxed">
                "{item.prompt}"
              </p>
      ...
      {previewItem && (
        ...
        >
          ...
          >
            ...
            <button 
              onClick={() => setPreviewItem(null)}
              className="absolute -top-4 -right-4 p-2 bg-white rounded-full text-slate-900 shadow-lg hover:bg-slate-100 transition-colors"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
